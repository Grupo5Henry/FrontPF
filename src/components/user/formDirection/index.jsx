...
export default function DirectionForm() {
  ...
  function onSub(e) {
    ...
    state
      ? alert(
          "Voy a usar la ubicacion por defecto y tengo que hacer la orden de compra"
        )
      : !direction.calle || !direction.provincia_estado
      ? alert("Complete los campos pedidos")
      : porDefecto
      ? alert(
          "Tengo que modificar la shipping address y hacer la orden de compra"
        )
      : alert(
          "Tengo que hacer la orden de compra con la nueva ubicacion pero no alterar la ubicacion por defecto"
        );
  }
  return (
    <div
    ...
    >
      ...
      >
        <option value={true}>
          {/* {user.defaultShippingAddress} */}Calle falsa 123
        </option>
