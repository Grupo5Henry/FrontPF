    ...
    <div className="antialiased mx-auto max-w-screen-sm">
      ...
      <div className="space-y-4">
        ...
        {active === true ? (
          <form onSubmit={OnSubmit}>
            ...
            <label class="flex flex-col-reverse relative focus group mb-4">
              <input
                onChange={(e) => setEdescription(e.target.value)}
                type="text"
                required
                class="border-b-2 border-t-0 border-l-0 border-r-0 z-10  focus:outline-none  focus:outline-none resize-none  w-full"
              />

              <span class="absolute text-xl transform -translate-y-3 left-4 transition leading-10 group-focus-within:-translate-y-16"></span>
              <div onClick={()=> setActive(false)} class="flex justify-end cursor-pointer z-50">
      ...
      >
        ...
        >
          ...
          <div class="border-t-4 border-gray-200 p-6 flex justify-between">
            <button onClick={()=> setNoUser(false)} class="bg-[#4F46E5] focus:outline-none transition px-4 py-2 rounded-md text-white transition duration-500 ease-in-out">
              Cerrar
            </button>
            <button onClick={onEdit} class="bg-[#4F46E5]  focus:outline-none transition px-4 py-2 rounded-md text-white transition duration-500 ease-in-out">
              Editar
            </button>
          </div>
        </div>
