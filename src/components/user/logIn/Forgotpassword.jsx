...
function ForgotPassword() {
  ...
  const handleSubmit = (e) => {
    ...
    // }
    // console.log(email)
    fetch(`${BACK_URL}/user/forgot-password`, {
      method: "POST",
      crossDomain: true,
      headers: {
        ...
        <div className="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
          <div>
            ...
            <p className="w-80 text-center text-sm mb-8 font-semibold text-gray-700 tracking-wide cursor-pointer">
              ¿Olvidaste tu contraseña? No hay problema, escribe tu correo
              electronico y te llegara un correo con un link para cambiar tu
              contraseña
            </p>
          </div>
          ...
          <div className="text-center mt-6">
            <button
              className="py-3 w-64 text-xl text-white bg-blue-800 rounded-2xl  hover:bg-blue-500"
              type="submit"
            >
              Enviar Email
            </button>
